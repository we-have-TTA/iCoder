...
ActiveRecord::Schema.define(version: 2022_09_21_174256) do
  ...
  create_table "canvas_messages", force: :cascade do |t|
    t.text "content"
    t.bigint "room_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["room_id"], name: "index_canvas_messages_on_room_id"
  end
  ...
  add_foreign_key "canvas_messages", "rooms"
